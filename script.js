$(document).ready(function(){
  ...
  //Light Box 
  $(".hero-display .display").click(function(){
    
    $(".lightbox").addClass("active");
    $(".arrow .fa-x").click(function(){
  ...
  $(".slide.next").click(function(){
    ...
    lightboxCounter++;
    $(".lightbox .display")[0].src = `/images/image-product-${lightboxCounter}.jpg`;
    render(lightboxCounter);

  })

  $(".slide.previous").click(function(){

    if (lightboxCounter <= 1){
      lightboxCounter = 5;
    }
  ...
  function render (lightboxCounter){
    $(".lightbox .secondary-display").find(".current").removeClass("current");
    $(".lightbox .secondary-display").find(`.lb-${lightboxCounter}`).addClass("current");
   } 
